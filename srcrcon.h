...
extern src_rcon_error_t src_rcon_command_wait(src_rcon_t *r,
...
extern src_rcon_error_t src_rcon_auth_wait(src_rcon_t *r,
                                           src_rcon_message_t const *auth,
                                           size_t *off,
                                           void const *buf, size_t sz);

extern int src_rcon_serialize(src_rcon_t *r,
                              src_rcon_message_t const *m,
                              uint8_t **buf, size_t *sz);

extern int src_rcon_deserialize(src_rcon_t *r,
